        ...
        <div className="space-y-4">
          {!inviteCode ? (
            <div className="text-center py-6">
              ...
              <h3 className="text-fg font-semibold mb-2">Invite Code Not Available</h3>
            ...
            <>
              {/* Invite Code */}
              <div className="bg-fg/5 rounded-xl p-4">
                <label className="block text-fg/50 text-xs uppercase tracking-wider mb-2">
                  Invite Code
                </label>
                <div className="flex items-center gap-3">
                  <span className="text-3xl font-mono font-bold text-fg tracking-widest flex-1">
                    {inviteCode}
                  </span>
                  <button
              ...
              <div className="bg-fg/5 rounded-xl p-4">
                ...
                <div className="flex items-center gap-2">
                  <div className="flex-1 bg-fg/5 rounded-lg px-3 py-2 overflow-hidden">
                    <span className="text-fg/70 text-sm truncate block">
                      {inviteLink}
                    </span>
                  </div>
                  <button
              ...
              {isCommissioner && (
                <div className="pt-4 border-t border-fg/10">
                  <button
                    ...
                    className="w-full flex items-center justify-center gap-2 px-4 py-2 bg-fg/5 hover:bg-fg/10 text-fg/70 hover:text-fg rounded-xl transition-all text-sm"
                  >
                    {regenerating ? (
                  ...
                  <p className="text-fg/30 text-xs text-center mt-2">
